...
bool STUDENT::LOGIN_VALIDATION_FUNCTION()
{
    ...
    string STUDENT_FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Students\)" + GET_USERNAME() + ".txt";
...
bool STUDENT::STUDENT_FILL_OUT_THE_FEEDBACK_FORM_FUNCTION(int choice)
{
    ...
    string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Submitted Feedbacks\)" + GET_USERNAME() + ".txt";
    ...
    ifstream READ_FEEDBACK_FORM;
    ofstream WRITE_FEEDBACK_ANSWERS;
    READ_FEEDBACK_FORM.open(R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Feedback Form.txt)", ios::in);
...
void STUDENT::CHANGE_PASSWORD()
{
    ...
    string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Students\)" + GET_USERNAME() + ".txt";
    ofstream OVER_WRITE;
