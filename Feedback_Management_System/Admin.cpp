...
bool ADMIN::LOGIN_VALIDATION_FUNCTION()
{
	...
	cin >> PASSWORD;
	string ADMIN_FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Admin\ADMIN_LOGIN.txt)";
	string CHECK = GET_LOGIN_DATA(ADMIN_FILE_PATH.c_str()); 
	try     // Exception Handling incase of Unsuccessful Login
	{      
		if (CHECK == USERNAME)
		{
			ADMIN_FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Admin\ADMIN_PASSWORD.txt)";
...
void ADMIN::PRINT_FEEDBACK_FORM()
{
	...
	ifstream READ;
	string READ_LINE;
	READ.open(R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Feedback Form.txt)", ios::in);
	{
...
void ADMIN::ADD_QUESTION()
{
	...
	ofstream Read;
	Read.open(R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Feedback Form.txt)", ios::app);
	{
...
void ADMIN::REMOVE_QUESTION()
{
	...
	{     
		...
		if ((QUESTION <= LINE_COUNT) && (QUESTION >= 1))
		{
			...
			ofstream OVER_WRITE;
			OVER_WRITE.open(R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Feedback Form.txt)");
			{
				for (int i = 0; i < LINE_COUNT; i++)
				{
...
int ADMIN::ADMIN_MANAGE_STUDENTS_MENU_FUNCTION(int choice)
{
	...
	cout << "          |2. Search A Student  [CMS ID]               |" << endl;
	cout << "          |3. Remove A Student  [CMS ID]               |" << endl;
	cout << "          |4. Add A New Student [CMS ID]               |" << endl;
...
void ADMIN::TOTAL_STUDENTS()
{
	...
	int TOTAL_FILES = 0;
	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Students)";
...
void ADMIN::SEARCH_STUDENT()
{
	...
	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Students\)" + CMS_ID + ".txt";

	if (!CHECK_EXISTING_FILE(FILE_PATH.c_str())) //each student has it's own file, named as his/her CMS ID, if the students exists, it means his/her file MUST exist too
	{
		cout << "\n\n\n";
		cout << "          __________________________________________________\n";
		cout << "         |  No Student exists under this CMS ID...     \n";
		cout << "         |__________________________________________________\n";
	}
	else
	{
...
void ADMIN::REMOVE_STUDENT()
{
	...
	else
	{
		...
		string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Submitted Feedbacks\)" + CMS_ID + ".txt";//changing path to submitted feedback
...
int ADMIN::ADMIN_MANAGE_SUBMITTED_FEEDBACKS_MENU_FUNCTION(int choice)
{
	...
	cout << "          |2. Print  A Student's Feedback [CMS ID]          |" << endl;
	cout << "          |3. Remove A Student's Feedback [CMS ID]          |" << endl;
	cout << "          |4. Return to Main Menu                           |" << endl;
	cout << "          |5. Exit                                          |" << endl;
	{
		cout << "\n          Answer: ";
...
void ADMIN::TOTAL_SUBMITTED_FEEDBACKS()
{
	...
	int TOTAL_FILES = 0;
	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Submitted Feedbacks)"; 
	for (auto& p : filesystem::directory_iterator(FILE_PATH))
	{                                                        
		TOTAL_FILES++;                                      
...
bool ADMIN::PRINT_SUBMITTED_FEEDBACK_FORM()
{
	...
	string CMS_ID;
	cout << "              Enter CMS ID CODE: ";
	cin >> CMS_ID;

	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Submitted Feedbacks\)" + CMS_ID + ".txt";
...
void ADMIN::REMOVE_SUBMITTED_FEEDBACK()
{
	...
	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Feedback Form\Submitted Feedbacks\)" + CMS_ID + ".txt"; //default path for submitted feedbacks
...
void ADMIN::CHANGE_PASSWORD()
{
	...
	string FILE_PATH = R"(C:\Users\afnan\OneDrive\Desktop\OOP Project\OOP Project\Admin\ADMIN_PASSWORD.txt)";
	ofstream OVER_WRITE;
